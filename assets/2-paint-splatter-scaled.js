...
Brush.prototype.init = function ()
{
    ...
    this.y = (1 - Math.random()*Math.random()) * canvas.height - canvas.height / 2;
...
//    ctx.fillRect(-canvas.width / 2, -canvas.height / 2, canvas.width, canvas.height);
    ...
    if (living > 25) {
        if (living % 25 == 0) { console.log(living); }
    }

    else { console.log(living); }
